...
namespace TestProject.Forms
{
    public partial class ProductForm : Form
    {
        ...
        {
            int availableWidth = panel2.ClientSize.Width - 21;
        ...
        private void SetupCategoryButtons()
        {
            ...
            for (int i = 0; i < categories.Length; i++)
            {
                ...
                btn.Click += (s, e) => FilterByCategory((string)((Button)s).Tag);
        ...
        private void UpdateCategoryCounts()
        {
            ...
            foreach (var btn in flowCategoryPanel.Controls.OfType<Button>())
            {
                ...
                if (category != "All")
                {
                    int count = products.Count(p => p.CategoryName == category);
        ...
        private void FilterByCategory(string category)
        {
            ...
            {
                products = products.Where(p => p.Name.ToLower().Contains(searchText) || p.SKU.ToLower().Contains(searchText)).ToList();
            }
        ...
        private Panel CreateEnhancedProductCard(Product product)
        {
            ...
            // (keeping existing code to avoid repetition)
            ...
            using (Graphics g = Graphics.FromImage(bmp))
            {
                ...
                using (Font font = new Font("Segoe UI Emoji", 24))
                {
                    ...
                    switch (category)
                    {
                        ...
                        case "Syrups": icon = "🍯"; break;
                        case "Dairy": icon = "🥛"; break;
                        case "Toppings": icon = "✨"; break;
                        case "Flour": icon = "🌾"; break;
                        case "Breads": icon = "🍞"; break;
                        case "Pastries": icon = "🥐"; break;
