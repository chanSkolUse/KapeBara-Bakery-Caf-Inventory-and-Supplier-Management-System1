...
namespace TestProject.Services
{
    public class AuthService
    {
        ...
        private static User _currentUser;  // Make static to persist across instances
        ...
        {
            // Find user by ID (not email) to avoid issues with email changes
            ...
            if (existing != null)
            {
                ...
                // Also update the current user reference if it's the same user
